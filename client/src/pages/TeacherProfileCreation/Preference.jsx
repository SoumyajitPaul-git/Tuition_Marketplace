  ...
  return (
    <div className="space-y-4">
      <div className="relative">
        ...
        {/* Dropdown Menu */}
        {open && (
          <div className="absolute z-10 mt-1 w-full border border-gray-300 rounded-md bg-white shadow-lg max-h-40 overflow-y-auto">
      ...
      <div className="relative">
        ...
        >
          ...
          {areaOpen ? <FaChevronUp /> : <FaChevronDown />}
        </div>
